_base_ = [
    '../_base_/datasets/cochlear_sam_accre.py',
...
model = dict(
    ...
    test_cfg=dict(
        save_path='/nobackup/mip_eecs/sud/sam/sam_ali/result/',
        output_embedding=False
    ))
view1_pipline = [
    dict(type="ExtraAttrs", tag="view1"),
    dict(type="Crop", fix_size=(64, 64, 32)),
    # dict(type="RandomAffine3d"),
    # dict(type="RandomElasticDeformation"),
    dict(type="Resample", norm_spacing=(0.2, 0.2, 0.2)),
    dict(type="Crop", switch='fix', fix_size=(64, 64, 32)),
...
train_pipeline = [
    ...
    dict(type='ComputeAugParam', standard_spacing=(0.2, 0.2, 0.2), patch_size=(64, 64, 32)),
    dict(
